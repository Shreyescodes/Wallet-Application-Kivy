"""
we are getting inr is pressed w can add that to database and can make the card to set color 
"""
...
class DefaultCurrency(Screen):
    ...
    def on_enter(self):
        ...
        if users_default_currency != None:
                ...
                #setting in wallet
                wallet_details.ids.options_button.icon = self.options_button_icon_mapping[users_default_currency]  #setting the icon mapping

                #setting in withdraw
                withdraw_details.ids.options_button.icon = self.options_button_icon_mapping[users_default_currency]  #setting the icon mapping
